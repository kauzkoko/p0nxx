  ...
  <div class="wrapper flexCenter">
    ...
    <div class="w-$playgroundX aspect-1 bg-white relative">
      ...
      <div
        ...
        class="absolute bg-blue w-50px h-100% right-0 top-0 mr--50px transform-gpu rotate-180"
      >
        <div
          v-for="n in blueBars"
          class="bg-white w-100% h-10px mt-20px mb-20px"
      ...
      <div
        ...
        class="absolute bg-yellow w-100% h-50px left-0 top-0 mt--50px grid grid-cols-10 transform-gpu rotate-180"
      >
        <div
      ...
      <div
        ...
        class="absolute bg-red w-100% h-50px left-0 bottom-0 mb--50px grid grid-cols-10"
      >
        <div
          v-for="n in redBars"
...
const redBars = ref(15);
const blueBars = ref(12);
const greenBars = ref(11);
const yellowBars = ref(14);
