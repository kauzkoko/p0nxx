<template>
  <div class="wrapper flexCenter">
    <div class="fixed left-0 top-0">
      <div class="bg-blue text-black p-2 overflow-y-scroll">
        <div class="font-bold">how to play</div>
        <div>- keep the energy ball inside the cube as long as possible!</div>
        <div>- only two walls can be active at the same time</div>
        <div>- click the greyed out walls to activate them</div>
        <div>- alternatively use the keys a,s,w,d to toggle the walls</div>
        <div>- use key r to restart, e to end, p to pause the game</div>
      </div>
      ...
      <div class="bg-yellow text-black p-2 overflow-y-scroll">
        <div class="font-bold">highscores</div>
    ...
    <div class="w-$playgroundX aspect-1 bg-white relative">
      <div
        :style="{ opacity: playground.leftWall ? '100%' : '20%' }"
      ...
      <div
        :style="{ opacity: playground.rightWall ? '100%' : '20%' }"
      ...
      <div
        :style="{ opacity: playground.topWall ? '100%' : '20%' }"
      ...
      <div
        :style="{ opacity: playground.bottomWall ? '100%' : '20%' }"
